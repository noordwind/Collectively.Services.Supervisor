...
|Branch             |Build status                                                  
|-------------------|-----------------------------------------------------
|master             |[![master branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Supervisor.svg?branch=master)](https://travis-ci.org/noordwind/Coolector.Services.Supervisor)
|develop            |[![develop branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Supervisor.svg?branch=develop)](https://travis-ci.org/noordwind/Coolector.Services.Supervisor/branches)
...
The **Coolector.Services.Supervisor** is a service responsible for providing a simple status page accessible under */dashboard* endpoint that is responsible for checking the health status of the other Coolector services.
...
In order to run the **Coolector.Services.Supervisor** you need to have installed:
...
```
git clone https://github.com/noordwind/Coolector.Services.Supervisor
cd Coolector.Services.Supervisor/Coolector.Services.Supervisor
...
Please note that the following solution will only run the Supervisor Service which is merely one of the many parts required to run properly the whole Coolector system.
...
**Solution structure**
----------------
- **Coolector.Services.Supervisor** - core and executable project via *dotnet run* command.
- **Coolector.Services.Supervisor.Tests** - unit & integration tests executable via *dotnet test* command.